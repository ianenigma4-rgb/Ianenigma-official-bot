...
const DEFAULT_LOG = [
    { version: 'v5.2.0', date: '2026-06-17', changes: ["Session ID: added support for 'BlackHat~' and other single-tilde prefix formats", 'Fixed: .gpt/.gemini broke silently if prefix was changed via .setprefix', 'Added missing .ask command', 'Repository links updated to official repo'] },
